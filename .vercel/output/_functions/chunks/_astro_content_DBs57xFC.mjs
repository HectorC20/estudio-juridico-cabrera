import { a as createComponent, m as maybeRenderHead, d as renderTemplate, A as AstroError, U as UnknownContentCollectionError, R as RenderUndefinedEntryError, u as unescapeHTML, n as escape, o as renderUniqueStylesheet, p as renderScriptElement, q as createHeadAndContent, r as renderComponent } from './astro/server_DPPTnymn.mjs';
/* empty css                          */
...
const $$Footer = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<footer class="footer-container "> <div class="footer-content"> <div class="border-box-footer"></div> </div> <div class="footer-ul-link"></div> <ul class="footer-bottom"> <li>2024 - 2025 Estudio Jurídico Cabrera copyright - Desarrollado por </li> <li><a href="https://portfolio-beta-lovat-16.vercel.app/" target="_blank">Héctor
</a></li> </ul> <div class="fonts"> <link href="https://fonts.googleapis.com/css2?family=Assistant:wght@200..800&display=swap" rel="stylesheet"> <link href="https://fonts.googleapis.com/css2?family=Inspiration&display=swap" rel="stylesheet"> <link href="https://fonts.googleapis.com/css2?family=Inria+Serif:ital,wght@0,300;0,400;0,700;1,300;1,400;1,700&display=swap" rel="stylesheet"> <link href="https://fonts.googleapis.com/css2?family=Archivo+Black&display=swap" rel="stylesheet"> <link href="https://fonts.googleapis.com/css2?family=Asap+Condensed:ital,wght@0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap" rel="stylesheet"> <link href="https://fonts.googleapis.com/css2?family=Fjalla+One&display=swap" rel="stylesheet"> </div> </footer>`;
}, "F:/estudio-juridico-cabrera/src/components/partials/Footer.astro", void 0);

const $$Navbar = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<nav class="bottom-nav"> <div class="fnt-nav"> <div class="nav-content"> <!-- Nuevo contenedor --> <a href="/" class="nav-item"> <img src="https://res.cloudinary.com/dixzojb4s/image/upload/v1728398825/home_tf4fcc.svg" alt="inicio" class=" h-[5vh] mt-0.5"> <span>INICIO</span> </a> <a href="/blog" class="nav-item"> <img src="https://res.cloudinary.com/dixzojb4s/image/upload/v1729024537/blog_o9dspa.svg" alt="galeria" class="h-[5vh] mt-0.5"> <span>BLOG</span> </a> <a href="/noticias" class="nav-item"> <img src="https://res.cloudinary.com/dixzojb4s/image/upload/v1728398568/noticias_arogmw.svg" alt="noticias" class="h-[5vh] mt-0.5"> <span>NOTICIAS</span> </a> </div> </div> </nav>`;
}, "F:/estudio-juridico-cabrera/src/components/partials/Navbar.astro", void 0);
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_D8vBGM5j.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "PUBLIC_NODE_API_WAM": "https://app-management-web.vercel.app/wam", "SITE": "https://estudio-juridico-cabrera.vercel.app", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_BfusgFoG.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_CTEWCz_y.mjs');
...
export { $$Navbar as $, $$Footer as a, getCollection as g };
